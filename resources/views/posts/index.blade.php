    ...
    <div class="container">
        <div class="card d-flex flex-row">
            ...
            <div class="d-flex flex-column justify-content-center text-center p-4">
                ...
                <!-- Upvote -->
                <a href="{{ route('upvotePost') }}" onclick="event.preventDefault(); document.getElementById('upvotePost').submit();">
                ...
                <form enctype="multipart/form-data" id="upvotePost" action="{{ route('upvotePost') }}" method="POST" class="d-none">
                    @csrf
                ...
                <!-- Downvote -->
                <a href="{{ route('downvotePost') }}" onclick="event.preventDefault(); document.getElementById('downvotePost').submit();">
                ...
                <form enctype="multipart/form-data" id="downvotePost" action="{{ route('downvotePost') }}" method="POST" class="d-none">
                    @csrf
                    <input name="post_id" value="{{ $post->id }}" hidden/>
                </form>
            </div>
                ...
                <div class="d-flex flex-row">
                    <div class="flex-grow-1">
                        <div class="card-body">
                            ...
                            <div class="dropdown">
                                <!-- Comment button-->
                                <a class="btn navbar-toggler" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" style="width: 30rem;" aria-labelledby="comment">
                                    <form enctype="multipart/form-data" method="post" action="{{ route('comments.store') }}">
                                        ...
                                        <div class="form-floating mb-2">
                                            <textarea class="form-control mx-2" id="comment-content" placeholder="Post Content"
